...
class Particle {
    ...
    draw() {
        ...
        const fade =
            this.life < 20 ? this.life / 20 : this.life > this.maxLife - 20 ? (this.maxLife - this.life) / 20 : 1;
        ctx.beginPath();
...
const translations = {
    en: {
        ...
        support_desc:
            "If you enjoy the game or appreciate the work behind it, consider sponsoring the development of future projects.",
    ...
    de: {
        ...
        support_desc:
            "Wenn dir das Spiel gefällt oder du die Arbeit dahinter schätzt, erwäge die Unterstützung zukünftiger Projekte.",
    ...
    ru: {
        ...
        hero_sub:
            "Выживай. Сражайся. <em>Спасайся.</em> — Приключение, созданное одним человеком<br>от <em>Muhab Joumaa</em>",
        ...
        support_desc:
            "Если вам нравится игра или вы цените проделанную работу, рассмотрите возможность поддержки будущих проектов.",
